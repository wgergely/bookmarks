...
which includes the shader name and the texture type (for example, '{DEFAULT_PREFIX}_base', 
'{DEFAULT_PREFIX}_opacity').</p>
...
class PresetsWidget(QtWidgets.QDialog):
    ...
    def _create_ui(self):
        ...
        self.import_button = QtWidgets.QPushButton('Import Preset')
...
def run():
    ...
    try:
        ...
        pass
    instance = PresetsWidget(parent=maya_main_window())
    instance.show()
