...
SECTIONS = {
    0: {
        'name': 'Options', 'icon': 'icon', 'color': common.color(common.color_green), 'groups': {
            0: {
                0: {
                    'name': None, 'key': None, 'validator': None, 'widget': None, 'placeholder': None,
                    'description': None,
                    'help': 'This module allows you to sync data to between ShotGrid and the local asset items.'
                }, 1: {
                    'name': 'Asset Type', 'key': None, 'validator': None, 'widget': AssetTypeComboBox,
                    'placeholder': '', 'description': 'The type of asset to sync.',
                    ...
                    'name': 'Authenticate SG as User', 'key': 'sg_sync/auth_as_user', 'validator': None,
                    'widget': functools.partial(QtWidgets.QCheckBox, 'Enable'), 'placeholder': '',
                    'description': 'Authenticate as the current user on ShotGrid.',
                    'help': 'Authenticate as the current user on ShotGrid.'
                }, 3: {
                    'name': 'Create Asset Folders', 'key': 'sg_sync/create_folders', 'validator': None,
                    'widget': functools.partial(QtWidgets.QCheckBox, 'Enable'), 'placeholder': None,
                    ...
                    'name': 'Sync Data to ShotGrid', 'key': 'sg_sync/sync_data_to_shotgrid', 'validator': None,
                    'widget': functools.partial(QtWidgets.QCheckBox, 'Enable'), 'placeholder': None,
                    ...
                    'name': 'Sync Data to Bookmarks', 'key': 'sg_sync/sync_data_to_bookmarks', 'validator': None,
                    'widget': functools.partial(QtWidgets.QCheckBox, 'Enable'), 'placeholder': None,
        ...
        'name': 'Source Data', 'icon': 'file', 'color': common.color(common.color_dark_background), 'groups': {
            0: {
                0: {
                    'name': 'Input Asset Data', 'key': 'sg_sync/asset_data', 'validator': None, 'widget': ui.LineEdit,
                    'button': 'Pick', 'placeholder': 'path/to/asset_data.json',
                    ...
                    'help': 'Path to a source data file used to update ShotGrid entities and asset items. '
                            'The file should contain a dictionary with asset names as keys and a dictionary with asset '
                    ...
                    'name': 'SG Task Mapping', 'key': 'sg_sync/task_mapping', 'validator': None, 'widget': ui.LineEdit,
                    'button': 'Pick', 'placeholder': 'path/to/task_mapping.json',
                    'description': 'Path to a task mapping json file.',
                    'help': 'Path to a source config file used to map SG tasks to the server. '
                            'The file should contain a dictionary with asset types as keys and a dictionary with task '
                            'relative task paths. Make sure the task names correspond with the task names on ShotGrid: '
                            '\n'
                            '\n'
                            '{'
                            '\n'
        ...
        'name': 'Asset Template', 'icon': 'folder', 'color': common.color(common.color_dark_background), 'groups': {
            1: {
                0: {
                    'name': 'Asset Template', 'key': 'sg_sync/asset_template', 'validator': None,
        ...
        'name': 'ShotGrid', 'icon': 'sg', 'color': common.color(common.color_dark_background), 'groups': {
            0: {
                0: {
                    'name': 'Domain', 'key': 'shotgun_domain', 'validator': None, 'widget': ui.LineEdit,
                ...
                0: {
                    'name': 'Script Name', 'key': 'shotgun_scriptname', 'validator': None, 'widget': ui.LineEdit,
                    'placeholder': 'my-sg-script', 'description': 'A name of a ShotGrid Script.',
                }, 1: {
                    'name': 'API Key', 'key': 'shotgun_api_key', 'validator': None, 'protect': True,
                    'widget': ui.LineEdit, 'placeholder': 'abcdefghijklmno3bqr*1',
                ...
                0: {
                    'name': 'Login', 'key': 'sg_auth/login', 'validator': None, 'widget': ui.LineEdit,
                    'placeholder': '', 'description': 'Your ShotGrid login name',
                }, 1: {
                    'name': 'Password', 'key': 'sg_auth/password', 'validator': None, 'protect': True,
                    'widget': ui.LineEdit, 'placeholder': '', 'description': 'Your ShotGrid password',
                },
            },
        },
    },
...
SETTINGS_SECTIONS = {
    'sg_sync': (
    'sg_sync/auth_as_user', 'sg_sync/create_folders', 'sg_sync/sync_data_to_shotgrid', 'sg_sync/sync_data_to_bookmarks',
...
class ProgressDialog(QtWidgets.QProgressDialog):
    """
    A progress dialog that is used to show the progress of the processing.

    Methods:
        update_progress(value: int, maximum: int, message: str)
    """
...
class SyncWidget(base.BasePropertyEditor):
    def __init__(self, parent=None):
        super().__init__(
            SECTIONS, common.active('server'), common.active('job'), common.active('root'),
