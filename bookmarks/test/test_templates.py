...
class Test(base.BaseCase):
    ...
    def test_add_zip_template(self):
        ...
        with self.assertRaises(RuntimeError):
            actions.add_zip_template('str', 'str')
        with self.assertRaises(RuntimeError):
            actions.add_zip_template(base.random_str(32), base.random_str(32))
        with self.assertRaises(RuntimeError):
            actions.add_zip_template(
    ...
    def test_extract_zip_template(self):
        ...
        with self.assertRaises(RuntimeError):
            actions.extract_zip_template('str', 'str', 'str')
        with self.assertRaises(TypeError):
        ...
        for f in os.listdir(common.temp_path()):
            ...
            v = actions.extract_zip_template(
                common.temp_path() + os.sep + f,
                common.temp_path(),
                base.random_str(32)
            )
    ...
    def test_remove_zip_template(self):
        ...
        with self.assertRaises(TypeError):
            actions.remove_zip_template(1)
        with self.assertRaises(RuntimeError):
            actions.remove_zip_template(base.random_str(32))
        ...
        for f in os.listdir(common.temp_path()):
            ...
            actions.remove_zip_template(v, prompt=False)
